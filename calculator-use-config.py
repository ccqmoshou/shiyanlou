...
class Calculator(object):
    ...
    @classmethod
    def salary_finally(self, _salary):
        salary_finally = salary - self.social_fund(salary) - self.personal_tax(salary)
...
if __name__ == '__main__':
    ...
    for employee_id in employee_list:
        ...
        social_fund_pay = Calculator.social_fund
        tax_pay = Calculator.personal_tax
        salary_finally_pay = Calculator.salary_finally
